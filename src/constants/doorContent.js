export const doorContent = [
...

  {
    ...
    summary:
      "If you feel like you're always responding to problems instead of preventing them, there's a reason.",
    content: {
      paragraphs: [
        {
          text:
            "Systems haven't changed as much as they should have. They're still designed to move people through without really holding onto them."
        },
        {
          text:
...

  {
    ...
    summary:
      "DPC fixes care. Infrastructure hasn't caught up. When people move or practices change, continuity breaks.",
    content: {
      paragraphs: [
        {
          text:
...

  {
    ...
    summary:
      'For people who take an active role in their health. Not waiting for a crisis, but building over time.',
    content: {
      paragraphs: [
        {
          text:
            "Henrietta is being built for people who take an active role in their health, regardless of where they're starting from."
        },
        {
          text:
      ...
      closingParagraphs: [
        {
          text:
            "No matter your current health status, if you're someone who shows up proactively, this is for you."
        },
        {
          text:
            "We're looking for people who have agency and want to use it. Not because they're desperate, but because they're intentional."
        }
      ]
    }
  },
    ...
    content: {
      paragraphs: [
        { text: "Right now, we're building the foundation.", weight: 'medium' },
        {
          ...
          strong: 'Mapping where DPC exists'
        },
        {
          text:
            'Connecting people to care. Helping engaged individuals find DPC practices as the network develops.',
          strong: 'Connecting people to care'
        },
        {
          text:
            'Building the infrastructure. The groundwork that makes continuity and patient stewardship possible.',
          strong: 'Building the infrastructure'
        },
        {
          text:
            "When you join the registry, you're helping us understand where momentum already exists and where it needs support."
        }
      ],
      infoBox: {
...
export const footerContent = {
  ...
  grounding:
    "This project hasn't accepted corporate or institutional backing. What comes next depends on who stays close and why.",
  links: []
};
