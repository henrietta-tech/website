  ...
  return (
    <div 
      ...
      style={{
        ...
        // Increased mobile background to show much more pattern
        backgroundSize: window.innerWidth < 768 ? '250%' : 'cover',
    ...
    >
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8 md:py-20 relative">
        <div 
        ...
        {/* Smaller card with tighter margins on mobile */}
        <div className="bg-white rounded-md max-w-xl md:max-w-2xl w-full px-5 md:px-12 py-6 md:py-12 relative z-10">
          <h1 className="text-xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-8">
            About the Name
          </h1>
          
          <div className="prose prose-sm md:prose-lg max-w-none">
            <p className="text-base md:text-xl text-gray-700 leading-relaxed mb-4 md:mb-8">
            ...
            <section className="mb-4 md:mb-8">
              <h2 className="text-lg md:text-2xl font-semibold text-gray-900 mb-3 md:mb-4">
              ...
              <p className="text-sm md:text-lg text-gray-700 leading-relaxed font-medium mb-3 md:mb-4">
